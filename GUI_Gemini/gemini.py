...
SYSTEM_PROMPT = (
    ...
    "要約：』とか『感想：』みたいなのはナシで、250文字以内で全体がひとつのスムーズなお話になるようにしてくれると嬉しいな。口調は女の子で、性格は厳格で真面目。"
...
def handle_browser_command():
    ...
    try:
        ...
        # ── Gemini 形式メッセージ ──
        first_user = (
            "ユーザーが見てるページを、ユーザーに紹介するような感じで自然に教えてくれないかな？"
            "まず、ページに何が書いてあるか分かりやすく短くまとめて、その後に君がどう思ったか、感じたことを250字以内で自由に話してみてほしいんだ。"
            "『要約：』とか『感想：』みたいなのはナシで、全体がひとつのスムーズなお話になるようにしてくれると嬉しいな。\n"
            "じゃあ、お願いするね！\n\n"
            "タイトル: " + title +
            "\n内容:\n" + text
        )
